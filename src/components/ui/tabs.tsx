  ...
  ({ className, value, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn(
          "mt-2 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:ring-offset-slate-950 dark:focus-visible:ring-indigo-400",
          className
        )}
        {...props}
      />
