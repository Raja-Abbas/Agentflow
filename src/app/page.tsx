        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-6 flex items-center justify-center gap-4">
              ...
              <a href="https://www.producthunt.com/products/agentflow-6?launch=agentflow-6" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-xs text-slate-400 hover:text-slate-600 transition-colors">
